...
--# inherit Brakes, Alarm;
package  Console
  --# own Reset_Status, SPAD_Cnt;
  --# initializes Reset_Status, SPAD_Cnt;
is
   --subtype introduced to specify the range of SPAD counter. SPAD counter > 0 and < 2**31-1
   subtype SPAD_Cnt_SubType is Integer range 0..Integer'Last;
